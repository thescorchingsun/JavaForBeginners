...
public class Lesson6_For {

    public static void main(String[] args) {

        //Пока цифры 1 до 5 (включительно), печатается текст
        ...
        //Печатаем нечетные числа от 1 до 10 включительно.
        //1 вариант
        ...
        // 2 вариант
        // Если добавить шаг для более быстрой проверки, то вместо i++ будет i = i + 2 - это
        // делается для того, чтобы сократить кол-во проверок с 10 до 5.
        ...
        //Печатаем все числа 5 до 1 включительно
        for (int i = 5; i > 0; i--) {
            System.out.println(i);
        }
      ...
      Стараемся придумывать решения ТОЛЬКО с одним for
        ...
        //!!Дома напечатать с помощью методов!!
        //Напечатать песню
